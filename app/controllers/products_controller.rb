...
class ProductsController < AuthenticatedController
    ...
    def show
      ...
      headers = {"X-Shopify-Access-Token" => @current_shopify_session.token}

      @metafields = HTTParty.get('https://store88-myshopif.myshopify.com/admin/metafields.json?metafield[owner_id]=' +
